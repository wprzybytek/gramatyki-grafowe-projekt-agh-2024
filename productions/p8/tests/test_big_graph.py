...
def test_two_graphs_to_cover_p8():
    ...
    production.apply()
    if view:
        plot_graph(graph, "TEST 4 - AFTER PRODUCTION")
    ...
    assert graph.nodes['Q:2.5:0.5']['R'] == 1, "Node Q:2.5:0.5 should have R=0 before applying the production"
