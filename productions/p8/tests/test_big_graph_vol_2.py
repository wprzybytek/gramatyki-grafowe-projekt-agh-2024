...
def test_two_graphs_to_cover_p8():
    ...
    assert graph.nodes['Q:1.25:0.25']['R'] == 0, "Node Q:1.25:0.25 should have R=1 before applying the production"
    ...
    production.apply()
    if view:
        plot_graph(graph, "TEST 5 - AFTER PRODUCTION")
