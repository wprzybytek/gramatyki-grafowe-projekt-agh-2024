...
def prepare_valid_test_graph_p3() -> nx.Graph:
...
def prepare_valid_big_test_graph_p3() -> nx.Graph:
    ...
    G.add_nodes_from([
        ...
        ('v:7.5:10.0', {'label': 'v', 'x': 7.5, 'y': 10.0, 'h': 0}),
        ...
        ('v:10.0:7.5', {'label': 'v', 'x': 10.0, 'y': 7.5, 'h': 0}),
    ...
    G.add_edges_from([
        ...
        ('v:10.0:10.0', 'v:10.0:7.5', {'label': 'E', 'B': 1}),
        ('v:10.0:7.5', 'v:10.0:5.0', {'label': 'E', 'B': 1}),
        ...
        ('v:7.5:10.0', 'v:7.5:7.5', {'label': 'E', 'B': 0}),
        ('v:10.0:7.5', 'v:7.5:7.5', {'label': 'E', 'B': 0}),
        ...
        ('v:15.0:0.0', 'v:15.0:5.0', {'label': 'E', 'B': 1}),
        ('v:15.0:5.0', 'v:10.0:5.0', {'label': 'E', 'B': 1}),
        ('v:10.0:0.0', 'v:10.0:-5.0', {'label': 'E', 'B': 0}),
        ('v:10.0:0.0', 'v:15.0:0.0', {'label': 'E', 'B': 0}),

        ('Q:7.5:2.5', 'v:5.0:5.0'), ('Q:7.5:2.5', 'v:5.0:0.0'), ('Q:7.5:2.5', 'v:10.0:0.0'), ('Q:7.5:2.5', 'v:10.0:5.0'),
        ('Q:12.5:2.5', 'v:10.0:5.0'), ('Q:12.5:2.5', 'v:10.0:0.0'), ('Q:12.5:2.5', 'v:15.0:0.0'), ('Q:12.5:2.5', 'v:15.0:5.0'),
        ...
        ('Q:6.25:6.25', 'v:5.0:5.0'), ('Q:6.25:6.25', 'v:5.0:7.5'), ('Q:6.25:6.25', 'v:7.5:5.0'),('Q:6.25:6.25', 'v:7.5:7.5'),
        ('Q:6.25:8.75', 'v:5.0:7.5'), ('Q:6.25:8.75', 'v:5.0:10.0'), ('Q:6.25:8.75', 'v:7.5:7.5'),('Q:6.25:8.75', 'v:7.5:10.0'),
        ('Q:8.75:6.25', 'v:7.5:5.0'), ('Q:8.75:6.25', 'v:7.5:7.5'), ('Q:8.75:6.25', 'v:10.0:5.0'),('Q:8.75:6.25', 'v:10.0:7.5'),
        ('Q:8.75:8.75', 'v:7.5:7.5'), ('Q:8.75:8.75', 'v:7.5:10.0'), ('Q:8.75:8.75', 'v:10.0:7.5'),('Q:8.75:8.75', 'v:10.0:10.0'),
