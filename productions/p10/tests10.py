...
def get_7_nodes_graph_with_hanging_node_on_other_edge(x_shift=0, y_shift=0):
    G = get_graph_without_hanging_node(x_shift, y_shift)
    G.add_node(f"v:{5.5 + x_shift}:{1 + y_shift}", label="v", x=5.5 + x_shift, y=1 + y_shift, h=1)
    G.add_edge(f"v:{5.5 + x_shift}:{1 + y_shift}", f"v:{8 + x_shift}:{1 + y_shift}", label="E", B=1)
    G.add_edge(f"v:{5.5 + x_shift}:{1 + y_shift}", f"v:{2 + x_shift}:{1 + y_shift}", label="E", B=1)
    G.remove_edge(f"v:{8 + x_shift}:{1 + y_shift}", f"v:{2 + x_shift}:{1 + y_shift}")
    return G

def get_8_nodes_graph_with_2hanging_nodes(x_shift=0, y_shift=0):
    G = get_graph_without_hanging_node(x_shift, y_shift)
    G.add_node(f"v:{5.5 + x_shift}:{9 + y_shift}", label="v", x=5.5 + x_shift, y=9 + y_shift, h=1)
    G.add_edge(f"v:{5.5 + x_shift}:{9 + y_shift}", f"v:{8 + x_shift}:{9 + y_shift}", label="E", B=1)
    G.add_edge(f"v:{5.5 + x_shift}:{9 + y_shift}", f"v:{3 + x_shift}:{9 + y_shift}", label="E", B=1)
...
#     G = get_graph_with_1_hanging_node()
#     plot_graph(G, title="p10_1_test_with_1_hanging_node_p10_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_1_test_with_1_hanging_node_p10_apply_2_after")
#     assert nx.is_isomorphic(G, G_old)


# def test_with_2_hanging_nodes_p10_apply():
#     G = get_graph_with_2_hanging_nodes()
#     plot_graph(G, title="p10_2_test_with_2_hanging_nodes_p10_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_2_test_with_2_hanging_nodes_p10_apply_2_after")
#     assert nx.is_isomorphic(G, G_old)


# def test_without_hanging_node_p10_apply():
#     G = get_graph_without_hanging_node()
#     plot_graph(G, title="p10_3_test_without_hanging_node_p10_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_3_test_without_hanging_node_p10_apply_2_after")
#     assert nx.is_isomorphic(G, G_old)


# def test_with_hanging_node_p10_apply():
#     G = get_7_nodes_graph_with_hanging_node()
#     plot_graph(G, title="p10_4_test_with_hanging_node_p10_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_4_test_with_hanging_node_p10_apply_2_after")
...
#     plot_graph(G, title="p10_5_test_two_hexagons_with_1_hanging_node_with_common_vertex_p10_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_5_test_two_hexagons_with_1_hanging_node_with_common_vertex_p10_apply_2_after")
#     assert nx.is_isomorphic(G, G_old)

#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_5_test_two_hexagons_with_1_hanging_node_with_common_vertex_p10_apply_3_after")
#     assert nx.is_isomorphic(G, G_old)
...
#     plot_graph(G, title="p10_6_test_get_two_hexagons_without_hanging_node_with_common_vertex_p10_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_6_test_get_two_hexagons_without_hanging_node_with_common_vertex_p10_apply_2_after")
#     assert nx.is_isomorphic(G, G_old) is False
...
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_6_test_get_two_hexagons_without_hanging_node_with_common_vertex_p10_apply_3_after")
#     assert nx.is_isomorphic(G, G_old) is False
...
#     plot_graph(G, title="p10_7_test_without_hanging_node_b0_p09_apply_1_before")
#     G_old = G.copy()
#     ProductionP10(G).apply()
#     plot_graph(G, title="p10_7_test_without_hanging_node_b0_p09_apply_2_after")
